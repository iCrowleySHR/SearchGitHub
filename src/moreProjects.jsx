        ...
        <section className={styles.section}>
            ...
            <section className={styles.showcaseProjects}> 
                <article className={styles.projects}>
                    ...
                    <a href='https://icrowleyshr.github.io/DailyJoke/' target='_blank'>See more!</a>
                </article>
                <article className={styles.projects}>
                    <img src={battleTetris} alt="Image from project Battle Tetris" className={styles.imgProjects}/>
                    <h2 translate='no'>Battle Tetris</h2>
                    <p>
                    ...
                    <a href='https://icrowleyshr.github.io/battle-tetris/' target='_blank' >See more!</a>
                </article>
            </section>
        </section>
        </>
